...
def generate_data(i,n,n_test,xlim_min,xlim_max):
    if i==0:
        ...
        Y = abs(X)  +  H + np.random.normal(0, 1, n)#+np.sin(X)
        X_test = np.linspace(min(X), max(X),n_test) #np.random.uniform(min(X),max(X),n_test)
        causal_effect = abs(X_test)#+np.sin(X_test)
...
def simulateAndPlot(n,experiments,nb_estimators,n_test,titles,nb_rep,ylim_min,ylim_max,xlim_min,xlim_max,xticks,yticks):
    ...
    for i in experiments:
        ...
        plt.savefig("C:\\Users\samjo\OneDrive\Documents\école\ETH\causality\plots\simulation\simMeant0"+str(i)+".pdf", bbox_inches='tight',pad_inches =0)
        plt.show()
        ...
        plt.gcf().set_size_inches(4, 4) 
        plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
        plt.savefig("C:\\Users\samjo\OneDrive\Documents\école\ETH\causality\plots\simulation\simMeant1"+str(i)+".pdf", bbox_inches='tight',pad_inches =0)
        plt.show()
        ...
        plt.gcf().set_size_inches(4, 4) 
        plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
        plt.savefig("C:\\Users\samjo\OneDrive\Documents\école\ETH\causality\plots\simulation\simMeant2"+str(i)+".pdf", bbox_inches='tight',pad_inches =0)
        plt.show()
        ...
        plt.gcf().set_size_inches(4, 4) 
        plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
        plt.savefig("C:\\Users\samjo\OneDrive\Documents\école\ETH\causality\plots\simulation\simMeant4"+str(i)+".pdf", bbox_inches='tight',pad_inches =0)
        plt.show()
        ...
        plt.gcf().set_size_inches(4, 4) 
        plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
        plt.savefig("C:\\Users\samjo\OneDrive\Documents\école\ETH\causality\plots\simulation\simMeant5"+str(i)+".pdf", bbox_inches='tight',pad_inches =0)
        plt.show()
        ...
        plt.gcf().set_size_inches(4, 4) 
        plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
        plt.savefig("C:\\Users\samjo\OneDrive\Documents\école\ETH\causality\plots\simulation\simMeant6"+str(i)+".pdf", bbox_inches='tight',pad_inches =0)
        plt.show()
        ...
        plt.gcf().set_size_inches(4, 4) 
        plt.subplots_adjust(left=0, right=1, top=1, bottom=0)
        plt.savefig("C:\\Users\samjo\OneDrive\Documents\école\ETH\causality\plots\simulation\simMeant7"+str(i)+".pdf", bbox_inches='tight',pad_inches =0)
        plt.show()
